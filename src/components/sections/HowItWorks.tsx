...
const steps = [
  {
    ...
    description:
      "Beginner, transformation, or premium — find your level",
  },
  {
    title: "We handle everything",
    description:
      "Safety, guides, food, stays — fully curated",
  },
  {
    title: "The journey begins",
    description:
      "Discomfort, community, breakthrough",
  },
  {
    title: "Return transformed",
    description:
      "Carry the monk mindset back home",
  },
];

export const HowItWorks = () => {
  return (
    <section className="relative py-40 px-6 bg-parchment-texture overflow-hidden">
      <div className="container mx-auto max-w-7xl relative z-10 text-center">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-8">
          ...
          <div className="hidden md:block absolute top-10 left-[12.5%] right-[12.5%] h-px border-t border-dashed border-[#8c7851]/30 z-0" />
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <p className="font-sans font-medium text-[#8c7851] text-[13px] leading-relaxed max-w-[200px]">
                {step.description}
              </p>
            </motion.div>
          ))}
