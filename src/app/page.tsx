...
const FeaturedTreks = dynamic(() => import("@/components/sections/FeaturedTreks").then(mod => mod.FeaturedTreks), {
  loading: () => <div className="h-96 animate-pulse bg-parchment/20" />,
});

const HandWrittenTitle = dynamic(() => import("@/components/ui/hand-writing-text").then(mod => mod.HandWrittenTitle));

const TestimonialCarousel = dynamic(() => import("@/components/ui/TestimonialCarousel").then(mod => mod.TestimonialCarousel), {
