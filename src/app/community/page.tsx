  ...
  return (
    <div>
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-6 relative z-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button
              variant="saffron"
              size="lg"
              className="rounded-full px-10 py-8 text-lg font-bold group shadow-xl shadow-saffron/20"
            >
              Join the Circle{" "}
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4">
          ...
          <div className="w-px h-12 bg-linear-to-b from-saffron to-transparent animate-scroll-pulse" />
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
              <input
                ...
                className="grow bg-white/5 border border-white/10 rounded-full px-8 py-5 text-white focus:outline-none focus:ring-2 focus:ring-saffron/50 transition-all"
              />
              <Button
                variant="saffron"
            ...
            <div className="mt-16 flex items-center justify-center gap-12 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
              <Mail className="size-8 text-white cursor-pointer" />
              <Mail className="size-8 text-white cursor-pointer" />
              <Mail className="size-8 text-white cursor-pointer" />
              <Mail className="size-8 text-white cursor-pointer" />
            </div>
